...
func init() {
	...
	// 默认昵称
	adana := flag.String("n", "小喵喵狐", "Set default nickname.")
	...
	config.Z = zero.Config{
		NickName:      append([]string{*adana}, "大猫猫狐", "小猫猫狐", "中等喵喵狐", "超级喵喵狐"),
...
func main() {
	...
	// 帮助
	zero.OnFullMatchGroup([]string{"/菜单"}, zero.OnlyToMe).SetBlock(true).
